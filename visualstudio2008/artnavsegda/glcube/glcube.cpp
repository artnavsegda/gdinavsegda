...
reshape(int width, int height)
{
    ...
    glLoadIdentity();
    gluPerspective(70.0, (float)width/height, 0.001, 100.0);
...
//#define TOP glIndexi(1); glColor3f(1.0f, 0.0f, 0.0f); glVertex3f(0.0, 1.0, 0.0)
...
//#define BL  glIndexi(2); glColor3f(1.0f, 0.0f, 1.0f); glVertex3i(-1, -1, -1)
...
#define TOP glIndexi(1); glColor3f(1.0f, 0.0f, 0.0f); glVertex3f(0.0, 1.0, 0.0)
#define B1 glIndexi(1); glColor3f(0.0f, 1.0f, 0.0f); glVertex3d(getcortx(1,myradius), -1.0, getcorty(1,myradius))
#define B2 glIndexi(2); glColor3f(0.0f, 0.0f, 1.0f); glVertex3d(getcortx(2,myradius), -1.0, getcorty(2,myradius))
#define B3 glIndexi(3); glColor3f(1.0f, 1.0f, 0.0f); glVertex3d(getcortx(3,myradius), -1.0, getcorty(3,myradius))
#define B4 glIndexi(4); glColor3f(0.0f, 1.0f, 1.0f); glVertex3d(getcortx(4,myradius), -1.0, getcorty(4,myradius))
#define B5 glIndexi(5); glColor3f(1.0f, 0.0f, 1.0f); glVertex3d(getcortx(5,myradius), -1.0, getcorty(5,myradius))
	...
	LPSTR lpszCmdLine, int nCmdShow)
{
    ...
    hWnd = CreateOpenGLWindow("mouse", 0, 0, 1000, 1000, color, buffer);
    if (hWnd == NULL)
	exit(1);
